...
{
	{	"!help",			DiscordCommands::Help,		""									},
	{	"!balance",			DiscordCommands::Balance,	""									},
	{	"!myaddress",		DiscordCommands::MyAddress,	""									},
	{	"!history",			DiscordCommands::History,	""									},
	{	"!withdraw",		DiscordCommands::Withdraw,	"[amount] [address]"				},
	{	"!withdrawall",		DiscordCommands::Withdraw,	"[amount]"							},
	{	"!give",			DiscordCommands::Give,		"[amount] [@User1 @User2...]"		},
	{	"!giveall",			DiscordCommands::GiveAll,	"[@User]"							},
};
	...
	try
	{
		...
		if (cmd.count())
		{
			for (const auto & command : Commands)
			{
				...
				{
					static_cast<CommandFunc>(command.func)(DiscordPtr, message, command);
				}
			}
		}
	}
