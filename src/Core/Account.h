...
public:
    ...
    TransferRet                 transferMoneyToAddress(std::uint64_t amount, const std::string & address, const std::string payment_id = {});
    TransferRet                 transferAllMoneyToAddress(const std::string & address, const std::string payment_id = {});
