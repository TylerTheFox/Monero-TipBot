...
void ScriptDefs::core_datatypes_impli() const
{
    ...
    chaiscript::utility::add_class<RPC>(*m,
        ...
        },
        {
            ...
            { chaiscript::fun(static_cast<TransferRet(RPC::*)(const std::string &, std::uint64_t, const std::string &, int, int) const>(&RPC::tranfer)), "tranfer" },
            { chaiscript::fun(static_cast<TransferRet(RPC::*)(const std::string &, const std::string &, int, int) const>(&RPC::sweepAll)), "sweepAll" },
